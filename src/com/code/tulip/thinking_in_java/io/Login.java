...
public class Login implements Serializable{
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        Login a = new Login("com/code/tulip/thinking_in_java", "com/code/tulip/thinking_in_java");
        System.out.println(a);
        ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream("/Users/code-tulip/testdataset/Login.txt"));
        out.writeObject(a); // 会利用反射来检查a所代表的类有没有自己的writeObject方法
        out.close();

        // 反序列化回来
        ObjectInputStream in = new ObjectInputStream(new FileInputStream("/Users/code-tulip/testdataset/Login.txt"));
