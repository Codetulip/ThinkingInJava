...
public class Blip3 implements Externalizable {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream("/Users/code-tulip/testdataset/Blip3.out"));
        ...
        ObjectInputStream in = new ObjectInputStream(new FileInputStream("/Users/code-tulip/testdataset/Blip3.out"));
