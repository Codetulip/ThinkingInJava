...
public class Blips {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream("/Users/code-tulip/testdataset/Blips.out"));
        ...
        //反序列化
        ObjectInputStream in = new ObjectInputStream(new FileInputStream("/Users/code-tulip/testdataset/Blips.out"));
