...
package com.code.tulip.thinking_in_java.typeinfo.toys;
...
//        c = FancyToy.class;  // 且不会触发初始化
        try {
            c = Class.forName("com.code.tulip.thinking_in_java.typeinfo.toys.FancyToy");
      ...
      /*  try {
       ...
       // 利用反射机制调用非默认构造器
        try {
            c = Class.forName("com.code.tulip.thinking_in_java.typeinfo.toys.Toy");
            try {
                // 非public构造器 无法获取
