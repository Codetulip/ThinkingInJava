...
public class Worm implements Serializable {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        // 写入磁盘文件,序列化
        ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream("/Users/tujing/testdataset/worm.out"));
        out.writeObject("Worm Storage\n");
        out.writeObject(w1);
        out.close(); // 会清空输出

        // 读取磁盘文件，反序列化
        ObjectInputStream in = new ObjectInputStream(new FileInputStream("/Users/tujing/testdataset/worm.out"));
