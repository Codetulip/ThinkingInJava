...
public class GetChannel {
    ...
    public static void main(String[] args) throws Exception {
        // 写文件
        FileChannel fc = new FileOutputStream("/Users/tujing/testdataset/data.txt").getChannel();
        // wrap方法将字节数组封装成ByteBuffer
        fc.write(ByteBuffer.wrap("some text ".getBytes()));
        fc.close();

        // 移动到文件最后 再写入信息
        fc = new RandomAccessFile("/Users/tujing/testdataset/data.txt","rw").getChannel();
        fc.position(fc.size());
        fc.write(ByteBuffer.wrap("some more".getBytes()));
        fc.close();

        // 读文件
        fc = new FileInputStream("/Users/tujing/testdataset/data.txt").getChannel();
